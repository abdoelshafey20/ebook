                    ...
                    <ul class="navbar-nav ms-lg-auto me-lg-4">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                {{-- <div class="dropdown-menu d-lg-block nav-item dropdown-menu-right" aria-labelledby="navbarDropdown">
                                 ...
                                 document.getElementById('logout-form').submit();">
                                    ...
                                    <form id="logout-form" action={{ route('logout') }} method="POST" class="d-none d-lg-block">
                                        @csrf
                                    </form>
                                </div> --}}
                                ...
                                <div class="dropdown-menu dropdown nav-item d-none d-lg-block dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item dropdown nav-link d-lg-block " href={{ route('logout') }}
                                        onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();">
                                        {{ __('Logout') }}
                                    </a>

                                    <form id="logout-form" action={{ route('logout') }} method="POST" class="d-none  nav-link dropdown  nav-item">
                                        @csrf
